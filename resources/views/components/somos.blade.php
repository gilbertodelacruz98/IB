<section class="page-section" id="somos">
    <div class="container">
        <div class="row">
            <div class="col-lg-12 text-center">
                <h2 class="section-heading text-uppercase">Quiénes somos</h2>
                <h3 class="section-subheading text-muted">Inside Business México, S.A. de C.V.</h3>
            </div>
        </div>
        <div class="container">
            <div class="row">
                <div class="col-md-7">
                    ...
                    <p class="grey-text">
                        ...
                        Hoy 10 años después, incursionando en el mercado como integradores especializados en telecomunicaciones
            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-md-6 mb-4">
                    <div class="card card-body text-center">
                        ...
                        <h6 class="font-weight-bold title">Cobertura</h6>
                        ...
                        <ul class="nav md-pills pills-primary flex-center" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link active" data-toggle="tab" href="#mision" role="tab" aria-selected="true">
                                    <span class="hint--error hint--top hint--bounce" aria-label="Mostrar Misión">
                                       <i class="fas fa-rocket fa-2x"></i><br>Misión
                                    </span>   
                                </a>                          
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" data-toggle="tab" href="#vision" role="tab" aria-selected="false">
                                    <span class="hint--error hint--top hint--bounce" aria-label="Mostrar Visión">
                                        <i class="fas fa-bullseye fa-2x"></i><br>Visión
                                    </span>  
                                </a>
                            </li>
                        </ul>
